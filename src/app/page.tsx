    ...
    <div className={styles.container}>
      ...
      <header className={styles.hero}>
        <div className={styles.logoContainer}>
          <Image src="/images/logo-econos.png" alt="Econos" width={200} height={44} className={styles.logo} priority />
          <div className={styles.divider}></div>
          <Image src="/images/logo-smm.png" alt="Social Media Manager IA" width={170} height={56} className={styles.logo} priority />
        </div>
