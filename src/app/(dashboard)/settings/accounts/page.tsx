  ...
  return (
    <div className={styles.container}>
      <div>
        ...
        <p className={styles.subtitle}>Conecta tus redes sociales y concede los permisos necesarios para poder publicar directamente desde SMM.</p>
      </div>
      ...
      <div className={styles.infoBox}>
        <div className={styles.revocationLinks}>
          <p style={{ fontWeight: '500', fontSize: '0.8rem', opacity: 0.9 }}>Gestión de seguridad y privacidad:</p>
